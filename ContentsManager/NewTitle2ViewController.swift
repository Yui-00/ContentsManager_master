//
//  NewTitle2ViewController.swift
//  ContentsManager
//
//  Created by 田口翔也 on 2021/06/27.
//
...
class NewTitle2ViewController: UIViewController, UITextFieldDelegate, UIScrollViewDelegate ,UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if existingItem != nil {
            ...
            if let imageData = UIImage(contentsOfFile: documentDirectoryFileURL.path){
                ...
                addImageButton.setImage(imageData.image?.withRenderingMode(.alwaysOriginal), for: .normal)
            }
            //整える
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self,
                selector: #selector(NewTitle2ViewController.keyboardWillShow(_:)),
                name: UIResponder.keyboardWillShowNotification,
                object: nil)
        NotificationCenter.default.addObserver(self,
                selector: #selector(NewTitle2ViewController.keyboardWillHide(_:)) ,
    ...
    func changeToKatakanaString(str: String) -> String {
        return TextConverter2.convert(str, to: .katakana)
    }
...
extension NewTitle2ViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
